...
def calc_rdm(
    ...
    if isinstance(dataset, Iterable):
        ...
        if method == 'euclidean':
            ...
            rdm = calc_mean_profile(dataset, descriptor)
        elif method == 'poisson':
...
def calc_mean_profile(
    ...
    vals = measurements.mean(axis=1)
    return _build_rdms(vals, dataset, 'mean_activation_profile', descriptor, desc)
